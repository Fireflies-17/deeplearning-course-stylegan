...
> “ADA 相比 noaug 改善 FID”在两种子下排序一致。E4 两次运行也都低于 E1，但 E4/E4b 的 seed
> 同时改变模型随机性和确定性抽取的 50k 子集，因此这不是纯种子重复，不能推出“数据越少越好”。

目的：复核两条主线现象。ADA 开/关轴可作为 n=2 种子范围；数据规模轴还混入子集抽样差异。
